...
class ScriptDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        if self.has_script_maker:
            ...
            self.btn_open_script_maker.setIcon(QIcon(f"{config_.app_dir}\\resources\\wizard.png"))
        ...
        self.button_box.button(QDialogButtonBox.Ok).setIcon(QIcon(f"{config_.app_dir}\\resources\\ok.png"))
        ...
        self.button_box.button(QDialogButtonBox.Cancel).setIcon(QIcon(f"{config_.app_dir}\\resources\\cancel.jpg"))
    ...
    def validate(self):
        try:
            ...
            msg = QMessageBox()
            msg.setWindowIcon(QIcon('{}\\resources\\icone.png'.format(config_.app_dir)))
