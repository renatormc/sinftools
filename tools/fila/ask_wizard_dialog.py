...
class AskWizardDialog(QDialog):
    ...
    def setup_ui(self):
        self.setWindowIcon(QIcon(f"{config_.app_dir}\\resources\\icone.png"))
        ...
        self.button_box.button(QDialogButtonBox.Ok).setIcon(QIcon(f"{config_.app_dir}\\resources\\wizard.png"))
        ...
        self.button_box.button(QDialogButtonBox.Cancel).setIcon(QIcon(f"{config_.app_dir}\\resources\\script.png"))
