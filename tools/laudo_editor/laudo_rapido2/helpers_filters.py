class NumeroExtenso():
    ...
    def getExtenso(self, num, quebradelinhas=0, female=False):
        """
        ...
        string.
        """
        self.trioextenso = self.trioextenso_feminino if female else self.trioextenso_masculino
...
def get_extenso(num, female=False):
    if not isinstance(num, str):
        num = str(num)
    n = NumeroExtenso()
    return n.getExtenso(num, quebradelinhas=0, female=female)
